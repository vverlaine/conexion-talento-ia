...
| [`04-propuesta/`](./04-propuesta) | **Entregable del viernes**: `propuesta-comercial.md` — por fases, **3 modelos de pricing con cifras**, cuadro de alternativas, economía unitaria y kit para la **reunión del martes** con Lili. | Completa (borrador, a pulir cifras) |
