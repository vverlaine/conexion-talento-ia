...
::: kpi
[63%]{.n}
[de los ingresos vienen de R&S — el foco]{.l}
:::
::: kpi
[~4.000]{.n}
...
En nuestra conversación quedó clara una ambición: que Conexión Talento sea una **consultora de RRHH de clase mundial**, con la **cercanía al candidato** como diferenciador. Y un pedido poco común que valoramos: que **te retemos**, no que te complazcamos. Esta propuesta honra ambos.

## Dónde estás hoy (diagnóstico)
...
- **"Mandé el mismo candidato dos veces al mismo cliente."** Falta un control de historial candidato–cliente → riesgo reputacional ya materializado.
- **"4 personas, 4 formatos de CV."** El criterio vive en cabezas, no en activos de la firma.
- **El equipo lee 200 CVs cuando podría entrevistar a los 3 correctos.** Tiempo operativo que ahoga la capacidad estratégica.
- **La base no se puede consultar.** "Buscar a un experto en IA entre 4.000" hoy es imposible.

# 2. Nuestro enfoque: estandarizar antes de automatizar
...
::: phase
[FASE 1]{.ph-tag} [4–6 semanas · 20–30 jornadas · US$9.500]{.ph-meta}

**Objetivo:** instalar la columna vertebral. Aquí vive el valor real y la capacidad que se queda.
...
::: phase
[FASE 2]{.ph-tag} [6–8 semanas · 25–35 jornadas · US$12.000 (modular)]{.ph-meta}
...
Ningún proceso se automatiza sin aprobar este checklist. Es la garantía de que **no automatizamos el caos**:
